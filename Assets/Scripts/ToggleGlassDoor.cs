...
public class ToggleGlassDoor : BaseInteraction
{
    ...
    public override void Interact()
    {
        ...
        if (windowIsOpen == false) 
        {
            ...
            interactionAnim.SetBool("GlassClosed", true);
            interactionAnim.SetBool("GlassOpen", false);
            //windowSound.Play(0);
        ...
        else
        {
            ...
            interactionAnim.SetBool("GlassClosed", false);
            interactionAnim.SetBool("GlassOpen", true);
            //windowSound.Play(0);
